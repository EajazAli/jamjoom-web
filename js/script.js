    ...
    27: [function (t, e, i) {
        ...
        var a = function (t) {
            ...
            return o(e, t), e.prototype.dispose = function () {
                ...
                t.prototype.animateIn.call(this, e), this.resize(), this.element[0].style.visibility = "inherit", this.timelineIn = new TimelineMax({}).fromTo(this.lines, .1, {
                    autoAlpha: 0
                }, {
                    autoAlpha: 1,
                    onComplete: this.onAnimateInComplete.bind(this)
                }, 0).fromTo(this.lines, 1, {
                    scale: 1.1
                }, {
                    scale: 1,
                    ease: Sine.easeInOut
                }, 0).add(this.startProgress.bind(this), .1)
                ...
                this.progressTimeline = new TimelineMax({
                    ...
                    drawSVG: "0",
                    ease: Quad.easeInOut
                }, 0), this.updateProgress(.15, this.progress ? null : 3)
            }, e.prototype.resetProgress = function () {
                TweenMax.killTweensOf({
                    progress: !0
                }), this.progress = 0, this.onProgressTweenUpdate(), this.updateProgress(.15, 1)
